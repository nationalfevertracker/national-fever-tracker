class TemperatureChecksController < ApplicationController
  ...
  private
    ...
    def temperature_check_params
      params.require(:temperature_check).permit(:temperature, :symptoms, :age, :loc_city, :loc_zip, :loc_state, :temperature_value, :cough, :sore_throat, :difficulty_breathing, :fatigue)
    end
end
